...
from ods_vova_themis.ods_vova_region r1
         left join
     ods_vova_themis.ods_vova_region r2 on r1.parent_id = r2.region_id
         left join
     ods_vova_themis.ods_vova_region r3 on r2.parent_id = r3.region_id
         left join
     ods_vova_themis.ods_vova_region r4 on r3.parent_id = r4.region_id;
"
