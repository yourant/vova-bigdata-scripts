...
sh /mnt/vova-bigdata-scripts/common/table_check.sh  ads.ads_vova_activity_user_only 60000 "pt='${pre_date}'"
...
sql="
drop table if exists themis.ads_activity_user_only_pre;
drop table if exists themis.ads_activity_user_only_new;
CREATE TABLE IF NOT EXISTS \`themis\`.\`ads_activity_user_only_new\` (
...
--m 1 \
--table ads_activity_user_only_new \
--hcatalog-database ads \
--hcatalog-table ads_vova_activity_user_only \
...
rename table themis.ads_activity_user_only to themis.ads_activity_user_only_pre,themis.ads_activity_user_only_new to themis.ads_activity_user_only;
EOF
echo "-------rename结束--------"
