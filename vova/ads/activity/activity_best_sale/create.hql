...
drop table if exists ads.ads_vova_activity_best_sale;
create external table if  not exists  ads.ads_vova_activity_best_sale (
...
)COMMENT 'super sale 活动表' PARTITIONED BY (pt string)
