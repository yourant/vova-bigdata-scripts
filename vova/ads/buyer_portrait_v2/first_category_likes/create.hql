drop table if exists ads.ads_vova_buyer_portrait_first_category_likes;
create external table ads.ads_vova_buyer_portrait_first_category_likes (
...
2020-09-23:
-- 中期的定义： 近16-60天
drop table if exists ads.ads_vova_buyer_portrait_first_category_likes_medium_term;
create external table ads.ads_vova_buyer_portrait_first_category_likes_medium_term (
    `buyer_id`          bigint         COMMENT 'd_买家id',
    `first_cat_id`      bigint         COMMENT 'd_一级品类id',
...
-- 长期的定义： 61天之前
drop table if exists ads.ads_vova_buyer_portrait_first_category_likes_long_term;
create external table ads.ads_vova_buyer_portrait_first_category_likes_long_term (
    `buyer_id`          bigint         COMMENT 'd_买家id',
    `first_cat_id`      bigint         COMMENT 'd_一级品类id',
    `ord_cnt`           int            COMMENT 'i_购买次数',
    `gmv`               decimal(14, 4) COMMENT 'i_购买gmv'
...
CREATE TABLE `ads.ads_vova_buyer_portrait_first_category_likes_exp`(
  `buyer_id` bigint COMMENT 'd_买家id',
  `first_cat_id` bigint COMMENT 'd_一级品类id',
