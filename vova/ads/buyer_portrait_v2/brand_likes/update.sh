...
sql="
ALTER TABLE ads.ads_vova_buyer_portrait_brand_likes DROP if exists partition(pt = '$(date -d "${pre_date:0:10} -30day" +%Y-%m-%d)');
INSERT overwrite TABLE ads.ads_vova_buyer_portrait_brand_likes partition(pt='$pre_date')
SELECT
/*+ REPARTITION(30) */
  buyer_id,
  brand_id,
...
INSERT OVERWRITE TABLE ads.ads_vova_buyer_portrait_brand_likes_with_click_15d
SELECT
/*+ REPARTITION(10) */
buyer_id,
brand_id,
...
ord_cnt_1m
FROM
ads.ads_vova_buyer_portrait_brand_likes
...
insert overwrite table ads.ads_vova_buyer_portrait_brand_likes_exp partition(pt='${pre_date}')
select
/*+ REPARTITION(15) */
  buyer_id,
  brand_id,
...
(
  ...
  (
    ...
    (
      ...
      from ads.ads_vova_buyer_portrait_brand_likes
  ...
  union all
    ...
    (
      ...
      from ads.ads_vova_buyer_portrait_brand_likes_medium_term
  ...
  union all
    ...
    (
      ...
      from ads.ads_vova_buyer_portrait_brand_likes_long_term
