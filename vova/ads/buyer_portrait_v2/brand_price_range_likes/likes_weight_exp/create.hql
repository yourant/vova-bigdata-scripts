...
-- 用户画像品牌偏好统计表
drop table if exists ads.ads_buyer_portrait_brand_price_range_likes;
create table if  not exists  ads.ads_buyer_portrait_brand_price_range_likes (
...
drop table if exists ads.ads_buyer_portrait_brand_price_range_likes_medium_term;
create table ads.ads_buyer_portrait_brand_price_range_likes_medium_term (
    `buyer_id`          bigint         COMMENT 'd_买家id',
    `brand_id`          bigint         COMMENT 'd_品牌id',
    `price_range`       int            COMMENT 'd_价格区间',
...
drop table if exists ads.ads_buyer_portrait_brand_price_range_likes_long_term;
create table ads.ads_buyer_portrait_brand_price_range_likes_long_term (
    `buyer_id`          bigint         COMMENT 'd_买家id',
    `brand_id`          bigint         COMMENT 'd_品牌id',
    `price_range`       int            COMMENT 'd_价格区间',
    `ord_cnt`           int            COMMENT 'i_购买次数',
...
drop table if exists ads.ads_buyer_portrait_brand_price_range_likes_exp;
create table ads.ads_buyer_portrait_brand_price_range_likes_exp (
    `buyer_id`            bigint           COMMENT 'd_买家id',
    `brand_id`            bigint           COMMENT 'd_品牌id',
    `price_range`         int              COMMENT 'd_价格区间',
    `likes_weight_short`  decimal(10, 6)   COMMENT 'i_短期偏好度',
    `likes_weight_medium` decimal(10, 6)   COMMENT 'i_中期偏好度',
    `likes_weight_long`   decimal(10, 6)   COMMENT 'i_长期偏好度',
    `likes_weight_synth`  decimal(10, 6)   COMMENT 'i_综合偏好度'
) COMMENT '用户画像品牌加价格区间偏好统计表品牌偏好度表(自然数计算)'
  PARTITIONED BY (pt string) ROW FORMAT DELIMITED FIELDS TERMINATED BY '\001' STORED AS PARQUETFILE;


alter table ads.ads_buyer_portrait_brand_price_range_likes_exp change column likes_weight_short likes_weight_short decimal(13,3) comment 'i_短期偏好度';
alter table ads.ads_buyer_portrait_brand_price_range_likes_exp change column likes_weight_medium likes_weight_medium decimal(13,3) comment 'i_中期偏好度';
alter table ads.ads_buyer_portrait_brand_price_range_likes_exp change column likes_weight_long likes_weight_long decimal(13,3) comment 'i_长期偏好度';
alter table ads.ads_buyer_portrait_brand_price_range_likes_exp change column likes_weight_synth likes_weight_synth decimal(13,3) comment 'i_综合偏好度';
