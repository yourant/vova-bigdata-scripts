...
sql="
ALTER TABLE ads.ads_buyer_portrait_brand_price_range_likes DROP if exists partition(pt = '$(date -d "${cur_date:0:10} -180day" +%Y-%m-%d)');

INSERT overwrite TABLE ads.ads_buyer_portrait_brand_price_range_likes partition(pt='${cur_date}')
SELECT
/*+ REPARTITION(40) */
  buyer_id,
  brand_id,
...
job4_name="ads_buyer_portrait_brand_price_range_likes_exp"

sql="
insert overwrite table ads.ads_buyer_portrait_brand_price_range_likes_medium_term partition(pt='${cur_date}')
SELECT
  /*+ REPARTITION(30) */
  buyer_id,
  brand_id,
...
insert overwrite table ads.ads_buyer_portrait_brand_price_range_likes_long_term partition(pt='${cur_date}')
select
/*+ REPARTITION(1) */
...
left join
  ods.dictionary_price_range_type prt
...
insert overwrite table ads.ads_buyer_portrait_brand_price_range_likes_exp partition(pt='${cur_date}')
select
/*+ REPARTITION(15) */
  buyer_id,
  brand_id,
...
(
  ...
  (
    ...
    (
      ...
      from ads.ads_buyer_portrait_brand_price_range_likes
  ...
  union all 
    ...
    (
      ...
      from ads.ads_buyer_portrait_brand_price_range_likes_medium_term
  ...
  union all 
    ...
    (
      ...
      from ads.ads_buyer_portrait_brand_price_range_likes_long_term
