...
# score 计算
job4_name="ads_vova_buyer_portrait_second_category_likes_exp"

###逻辑sql
sql="
insert overwrite table ads.ads_vova_buyer_portrait_second_category_likes partition(pt='${cur_date}')
SELECT
  /*+ REPARTITION(25) */
  buyer_id,
  second_cat_id,
...
insert overwrite table ads.ads_vova_buyer_portrait_second_category_likes_medium_term partition(pt='${cur_date}')
SELECT
  /*+ REPARTITION(15) */
  buyer_id,
  second_cat_id,
...
insert overwrite table ads.ads_vova_buyer_portrait_second_category_likes_long_term partition(pt='${cur_date}')
select
/*+ REPARTITION(1) */
...
insert overwrite table ads.ads_vova_buyer_portrait_second_category_likes_exp partition(pt='${cur_date}')
select
/*+ REPARTITION(15) */
  buyer_id,
  second_cat_id,
...
(
  ...
  (
    ...
    (
      ...
      from ads.ads_vova_buyer_portrait_second_category_likes
  ...
  union all
    ...
    (
      ...
      from ads.ads_vova_buyer_portrait_second_category_likes_medium_term
      where pt='${cur_date}' and min_clk_day_gap is not null
      GROUP by buyer_id
    ) r
    left join
  ...
  union all
    ...
    (
      ...
      from ads.ads_vova_buyer_portrait_second_category_likes_long_term
