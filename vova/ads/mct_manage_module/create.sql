...
drop table ads.ads_mct_manage_module;
CREATE  TABLE IF NOT EXISTS ads.ads_mct_manage_module
(
    ...
    mct_statu                       bigint         COMMENT '店铺状态1:删除;2:休假;3:在售;4:禁售',
...
alter table ads.ads_mct_manage_module add columns(`no_brand_gmv_last7d` DECIMAL(14, 4) comment '近7日非brand gmv') cascade;
alter table ads.ads_mct_manage_module add columns(`no_brand_gmv_last1d` DECIMAL(14, 4) comment '近1日非brand gmv') cascade;
