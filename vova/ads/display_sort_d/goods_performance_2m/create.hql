DROP TABLE ads.ads_vova_goods_performance_2m;
CREATE EXTERNAL TABLE IF NOT EXISTS ads.ads_vova_goods_performance_2m
(
    goods_id          bigint,
...
) COMMENT 'ads_vova_goods_performance_2m' PARTITIONED BY (pt STRING)
