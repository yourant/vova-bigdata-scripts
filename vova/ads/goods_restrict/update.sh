...
--conf "spark.app.name=ads_vova_goods_restrict_sntogsn_zhangyin" \
...
--env product --pt $pt --url https://merchant.vova.com.hk/api/v1/internal/Product/snToGsn --secret_key aik2Oo2he5Aiaa2hahpaPoodha2b
