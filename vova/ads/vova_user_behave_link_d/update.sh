...
--class com.vova.bigdata.sparkbatch.dataprocess.ads.GoodsClickCause s3://vomkt-emr-rec/jar/vova-goods-click-cause-v3.jar \
...
--conf "spark.app.name=ads_vova_user_behavior_link" \
...
DROP TABLE IF EXISTS tmp.tmp_user_behavior_link_11;
create table tmp.tmp_user_behavior_link_11 as
select
    a.session_id    ,
    a.buyer_id      ,
    a.gender        ,
...
where a.pt = '$cur_date' and a.rn = 0
...
insert into table tmp.tmp_user_behavior_link_11
select
    a.session_id    ,
    a.buyer_id      ,
    a.gender        ,
...
left join (SELECT event_fingerprint,
 ...
 WHERE pt <= '$cur_date' and pt >= date_sub('$cur_date',1)
   AND event_type = 'goods'
   AND platform = 'mob') b on a.buyer_id = b.buyer_id and a.device_id = b.device_id and unix_timestamp(a.expre_time,'yyyy-MM-dd HH:mm:ss') * 1000 > b.collector_tstamp
where a.pt = '$cur_date' and a.rn = 1
group by     a.session_id    ,
    a.buyer_id      ,
    a.gender        ,
    a.language_id   ,
...
left join (SELECT event_fingerprint,
 ...
 WHERE pt <= '$cur_date' and pt >= date_sub('$cur_date',1)
   AND event_type = 'goods'
   AND platform = 'mob') b on a.buyer_id = b.buyer_id and a.device_id = b.device_id and unix_timestamp(a.expre_time,'yyyy-MM-dd HH:mm:ss') * 1000 > b.collector_tstamp
where a.pt = '$cur_date' and a.rn = 2
group by     a.session_id    ,
    a.buyer_id      ,
    a.gender        ,
    a.language_id   ,
...
left join (SELECT event_fingerprint,
 ...
 WHERE pt <= '$cur_date' and pt >= date_sub('$cur_date',1)
   AND event_type = 'goods'
   AND platform = 'mob') b on a.buyer_id = b.buyer_id and a.device_id = b.device_id and unix_timestamp(a.expre_time,'yyyy-MM-dd HH:mm:ss') * 1000 > b.collector_tstamp
where a.pt = '$cur_date' and a.rn = 3
group by     a.session_id    ,
    a.buyer_id      ,
    a.gender        ,
    a.language_id   ,
...
left join (SELECT event_fingerprint,
 ...
 WHERE pt <= '$cur_date' and pt >= date_sub('$cur_date',1)
   AND event_type = 'goods'
   AND platform = 'mob') b on a.buyer_id = b.buyer_id and a.device_id = b.device_id and unix_timestamp(a.expre_time,'yyyy-MM-dd HH:mm:ss') * 1000 > b.collector_tstamp
where a.pt = '$cur_date' and a.rn = 4
group by     a.session_id    ,
    a.buyer_id      ,
    a.gender        ,
    a.language_id   ,
...
left join (SELECT event_fingerprint,
 ...
 WHERE pt <= '$cur_date' and pt >= date_sub('$cur_date',1)
   AND event_type = 'goods'
   AND platform = 'mob') b on a.buyer_id = b.buyer_id and a.device_id = b.device_id and unix_timestamp(a.expre_time,'yyyy-MM-dd HH:mm:ss') * 1000 > b.collector_tstamp
where a.pt = '$cur_date' and a.rn = 5
group by     a.session_id    ,
    a.buyer_id      ,
    a.gender        ,
    a.language_id   ,
...
left join (SELECT event_fingerprint,
 ...
 WHERE pt <= '$cur_date' and pt >= date_sub('$cur_date',1)
   AND event_type = 'goods'
   AND platform = 'mob') b on a.buyer_id = b.buyer_id and a.device_id = b.device_id and unix_timestamp(a.expre_time,'yyyy-MM-dd HH:mm:ss') * 1000 > b.collector_tstamp
where a.pt = '$cur_date' and a.rn = 6
group by     a.session_id    ,
    a.buyer_id      ,
    a.gender        ,
    a.language_id   ,
...
left join (SELECT event_fingerprint,
 ...
 WHERE pt <= '$cur_date' and pt >= date_sub('$cur_date',1)
   AND event_type = 'goods'
   AND platform = 'mob') b on a.buyer_id = b.buyer_id and a.device_id = b.device_id and unix_timestamp(a.expre_time,'yyyy-MM-dd HH:mm:ss') * 1000 > b.collector_tstamp
where a.pt = '$cur_date' and a.rn = 7
group by     a.session_id    ,
    a.buyer_id      ,
    a.gender        ,
    a.language_id   ,
...
left join (SELECT event_fingerprint,
 ...
 WHERE pt <= '$cur_date' and pt >= date_sub('$cur_date',1)
   AND event_type = 'goods'
   AND platform = 'mob') b on a.buyer_id = b.buyer_id and a.device_id = b.device_id and unix_timestamp(a.expre_time,'yyyy-MM-dd HH:mm:ss') * 1000 > b.collector_tstamp
where a.pt = '$cur_date' and a.rn = 8
group by     a.session_id    ,
    a.buyer_id      ,
    a.gender        ,
    a.language_id   ,
...
left join (SELECT event_fingerprint,
 ...
 WHERE pt <= '$cur_date' and pt >= date_sub('$cur_date',1)
   AND event_type = 'goods'
   AND platform = 'mob') b on a.buyer_id = b.buyer_id and a.device_id = b.device_id and unix_timestamp(a.expre_time,'yyyy-MM-dd HH:mm:ss') * 1000 > b.collector_tstamp
where a.pt = '$cur_date' and a.rn = 9
group by     a.session_id    ,
    a.buyer_id      ,
    a.gender        ,
    a.language_id   ,
...
from tmp.tmp_user_behavior_link_11 a
