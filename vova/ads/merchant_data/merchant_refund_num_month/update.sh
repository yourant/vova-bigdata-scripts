...
sql="
insert overwrite table ads.ads_vova_mct_refund_cnt_m partition(pt='${cur_date}')
...
spark-sql \
--conf "spark.app.name=ads_vova_mct_refund_cnt_m_yushijia" \
