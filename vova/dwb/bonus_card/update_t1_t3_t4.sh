...
group by cube(region_code, os_type, main_channel, is_new, gmv_stage, is_paid)
;
...
group by cube(region_code, platform, main_channel, is_new, gmv_stage, is_paid)
;
...
group by cube(pt, region_code, os_type, main_channel, is_new, gmv_stage, is_paid)
having pt !='all'
;
