...
job_name="dwb_vova_user_cohort_stp_2_req_chenkai_${cur_date}"

sql="
insert overwrite table dwb.dwb_vova_user_cohort PARTITION (pt = '2018-01-02')
...
--hcatalog-table dwb_vova_user_cohort \
--hcatalog-partition-keys pt \
--hcatalog-partition-values 2018-01-02 \
--fields-terminated-by '\001' \
--batch
