...
--env prod \
--sql "select goods_id,web_order_rate,web_order_rate_ratio,expre_efficiency,expre_efficiency_ratio,new_user_rate,new_user_rate_ratio,new_user_order_rate,new_user_order_ratio from dwb.dwb_vova_conversion_monitor where pt='2021-03-08' limit 1 " \
