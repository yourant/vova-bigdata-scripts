...
CREATE TABLE fact_pay(
 ...
 'properties.group.id' = 'ads_country_gmv_analysis',
 'format' = 'json',
...
CREATE TABLE ads_country_gmv_analysis (
     cur_date varchar(20),
     region_code string,
     gmv DECIMAL(10,2)
) WITH (
...
'connector.table'='ads_country_gmv_analysis',
...
insert into ads_country_gmv_analysis
select
...
group by  DATE_FORMAT(pay_ts,'yyyy-MM-dd'),region_code
;