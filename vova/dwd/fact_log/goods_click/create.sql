drop table IF EXISTS dwd.dwd_vova_log_goods_click;
CREATE external TABLE dwd.dwd_vova_log_goods_click(
...
LOCATION "s3://bigdata-offline/warehouse/dwd/dwd_vova_log_goods_click/"
;