drop table dwd.dwd_vova_web_fact_cart_cause;
CREATE EXTERNAL TABLE IF NOT EXISTS dwd.dwd_vova_web_fact_cart_cause
(
...
) COMMENT 'dwd_vova_web_fact_cart_cause' PARTITIONED BY (pt STRING)
