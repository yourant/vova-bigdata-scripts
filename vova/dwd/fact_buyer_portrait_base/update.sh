...
create table tmp.tmp_vova_fact_buyer_portrait_base_buy as
...
--step3 浏览行为2
drop table if exists tmp.fact_buyer_portrait_base_clk;
create table tmp.fact_buyer_portrait_base_clk as
...
2 act_type_id from
(
select datasource,virtual_goods_id,buyer_id from dwd.dwd_vova_fact_log_goods_click where pt='$pre_date' and buyer_id<> -1 and buyer_id is not null
) t1
left outer join
tmp.tmp_vova_fact_buyer_portrait_base_01 t2
...
--step4 评论行为3
drop table if exists tmp.fact_buyer_portrait_base_com;
create table tmp.fact_buyer_portrait_base_com as
...
--step5 收藏4,取消收藏5，加购6
drop table if exists tmp.fact_buyer_portrait_base_cart;
create table tmp.fact_buyer_portrait_base_cart as
...
(
select datasource,cast(element_id as bigint) virtual_goods_id,buyer_id,element_name from dwd.dwd_vova_fact_log_common_click
...
--step6,8：语言
drop table if exists tmp.fact_buyer_portrait_base_lan;
create table tmp.fact_buyer_portrait_base_lan as
select distinct datasource,buyer_id,language,country,1 cnt,8 act_type_id from dwd.dwd_vova_fact_log_screen_view
where pt='$pre_date' and buyer_id<> -1 and buyer_id is not null;
--step8,9:日活跃时段
drop table if exists tmp.fact_buyer_portrait_base_act;
create table tmp.fact_buyer_portrait_base_act as
...
--0-6:星期日-星期六，周活跃度
drop table if exists tmp.fact_buyer_portrait_base_act_w;
create table tmp.fact_buyer_portrait_base_act_w as
...
--月活跃度
drop table if exists tmp.fact_buyer_portrait_base_act_m;
create table tmp.fact_buyer_portrait_base_act_m as
...
--step6 退款完成行为7
drop table if exists tmp.fact_buyer_portrait_base_ref;
create table tmp.fact_buyer_portrait_base_ref as
select
/*+ REPARTITION(1) */
t1.datasource,
t3.buyer_id,
...
union all
select datasource,buyer_id,cast(goods_id as string) goods_id,goods_name,cnt,first_cat_id,act_type_id from tmp.fact_buyer_portrait_base_clk
union all
select datasource,buyer_id,cast(goods_id as string) goods_id,goods_name,cnt,first_cat_id,act_type_id from tmp.fact_buyer_portrait_base_com
union all
select datasource,buyer_id,cast(goods_id as string) goods_id,goods_name,cnt,first_cat_id,act_type_id from tmp.fact_buyer_portrait_base_cart
union all
select datasource,buyer_id,language goods_id,country goods_name,cnt,null first_cat_id,act_type_id from tmp.fact_buyer_portrait_base_lan
union all
select datasource,buyer_id,cast(tag_id as string) goods_id,tag_name goods_name,cnt,null first_cat_id,act_type_id from tmp.fact_buyer_portrait_base_act
union all
select datasource,buyer_id,cast(tag_id as string) goods_id,tag_name goods_name,cnt,null first_cat_id,act_type_id from tmp.fact_buyer_portrait_base_act_w
union all
select datasource,buyer_id,cast(tag_id as string) goods_id,tag_name goods_name,cnt,null first_cat_id,act_type_id from tmp.fact_buyer_portrait_base_act_m
union all
select datasource,buyer_id,cast(goods_id as string) goods_id,goods_name,cnt,first_cat_id,act_type_id from tmp.fact_buyer_portrait_base_ref
) t;
"
