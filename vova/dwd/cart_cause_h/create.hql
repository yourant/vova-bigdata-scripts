drop table tmp.tmp_vova_fact_cart_cause_h_glk_cause;
CREATE external TABLE IF NOT EXISTS tmp.tmp_vova_fact_cart_cause_h_glk_cause
(
...
drop table tmp.tmp_vova_fact_cart_cause_h_expre_cause;
CREATE external TABLE IF NOT EXISTS tmp.tmp_vova_fact_cart_cause_h_expre_cause
(
    datasource            string comment '数据平台',
    event_name            string comment '事件名称',
    virtual_goods_id      string comment '虚拟商品id',
