...
sed "s/{pt}/${pt}/g; \
      ...
      s/{decay}/${decay}/g;" ${script_dir}/user_cat_pref.sql > ${script_dir}/tmp_user_cat_pref.sql
sql=$(cat ${script_dir}/tmp_user_cat_pref.sql)
cat ${script_dir}/tmp_user_cat_pref.sql
