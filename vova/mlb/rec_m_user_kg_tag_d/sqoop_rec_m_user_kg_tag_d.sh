...
file_num=`s3://vova-mlb/REC/data/match/match_result/mlb_vova_rec_m_user_cat_expand_d/pt=${pre_date}/ | wc -l`
...
subcategory_list   varchar(100)  NOT NULL COMMENT '子品类列表',
...
--columns buyer_id,subcategory_list \
