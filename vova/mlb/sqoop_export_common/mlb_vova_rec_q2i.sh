...
if [ ! -n "${table_name}" ]; then
  echo "Error: 任务: mlb_sqoop_q2i, freedoms 中没有配置 table_name！！！"
  exit 1
fi
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='q2i 召回结果表';
...
--columns query,rec_goods_id_list,score_list,model_name \
