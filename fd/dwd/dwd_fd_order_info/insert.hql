...
/*+ REPARTITION(5) */
    ...
    ua.is_app,
    ua.device_type,
    lower(ua.device_id)                                      as device_id,
    lower(ua.idfv)                                           as idfv,
    ua.os_type,
...
from (
         select order_id,
                ...
                cast(unix_timestamp(to_utc_timestamp(order_time, 'America/Los_Angeles'),
                                    'yyyy-MM-dd HH:mm:ss') as BIGINT) AS order_time,
                order_status,
                shipping_status,
                pay_status,
                consignee,
                ...
                sign_building,
                postscript,
                cast(unix_timestamp(to_utc_timestamp(important_day, 'America/Los_Angeles'),
                                    'yyyy-MM-dd') as BIGINT)          AS important_day,
                sm_id,
                shipping_id,
                shipping_name,
                payment_id,
                ...
                cast(unix_timestamp(to_utc_timestamp(pay_time, 'America/Los_Angeles'),
                                    'yyyy-MM-dd HH:mm:ss') as BIGINT) AS pay_time,
                shipping_time,
                cast(unix_timestamp(to_utc_timestamp(shipping_date_estimate, 'America/Los_Angeles'),
                                    'yyyy-MM-dd') as BIGINT)          AS shipping_date_estimate,
                shipping_carrier,
