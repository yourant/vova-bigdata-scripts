...
select  reg.project,
        reg.platform_type,
        reg.country_code,
        reg.user_register_domain_userid,
        reg.user_new_domain_userid,
        reg.user_new_register_domain_userid,
        reg.user_order_id,
        reg.user_new_order_id,
        reg.user_new_first_order_id,
        reg.user_new_first_coupon_order_id,
        reg.user_new_first_success_order_id,
        reg.user_new_first_success_coupon_order_id
from (
    select
