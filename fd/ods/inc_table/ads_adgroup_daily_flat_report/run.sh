...
db_table_name="ads_adgroup_daily_flat_report"

######hive配置信息
hive_db_name="tmp"
#列名
hive_columns="adfr_id, account_name, campaign_id, campaign_name, ad_group_id, ad_group_name, category, ads_site_code, country, ga_channel, channel, cost, gmv, `date`, clicks, impressions, average_position"
