CREATE TABLE IF NOT EXISTS ods_fd_vb.ods_fd_goods_display_order_artemis_country_inc (
  `id` bigint,
...
INSERT OVERWRITE TABLE ods_fd_vb.ods_fd_goods_display_order_artemis_country_inc PARTITION (dt='${hiveconf:dt}')
select
    id,
    goods_id,
    country_code,
    ...
    last_update_time,
    sales   
from tmp.tmp_fd_goods_display_order_artemis_country where dt = '${hiveconf:dt}';
