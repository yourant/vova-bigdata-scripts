...
db_table_name="goods_display_order_artemis_country"

######hive配置信息
hive_db_name="tmp"
hive_columns="id ,goods_id ,country_code ,project_name ,platform ,impressions ,clicks ,users ,sales_order ,detail_add_cart ,list_add_cart ,checkout ,sales_order_in_7_days ,virtual_sales_order ,goods_order ,start_time ,end_time ,is_active ,last_update_time ,sales"
#hive tmp表在s3的路径
