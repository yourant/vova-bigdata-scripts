...
db_table_name="app_message_push"

######hive配置信息
hive_db_name="tmp"
#列名
hive_columns="id, install_record_id, notice_id, user_id, response, event_type, init_time, push_result, push_time"
#hive tmp表在s3的路径
