...
select id, goods_id, min_quantity, produce_days, change_provider, change_provider_days, change_provider_reason, pms_purchase, pms_purchase_days, is_delete, update_date, fabric, provider_type, audit_submit_time, audit_action_id, statu
from(
    select
    ...
    AS `table`, ts, `commit`, xid, type, old, id, goods_id, min_quantity, produce_days, change_provider, change_provider_days, change_provider_reason, pms_purchase, pms_purchase_days, is_delete, update_date, fabric, provider_type, audit_submit_time, audit_action_id, statu
