alter table ods_fd_ecshop.ods_fd_ecs_goods_arc drop if exists partition (pt='$pt');

INSERT into table ods_fd_ecshop.ods_fd_ecs_goods_arc PARTITION (pt = '${pt}')
select 
...
from (
    ...
    from (
        ...
        select  pt,
                ...
                erp_sku,
                create_time
        from ods_fd_ecshop.ods_fd_ecs_goods_inc where pt='${pt}'
    ) arc 
