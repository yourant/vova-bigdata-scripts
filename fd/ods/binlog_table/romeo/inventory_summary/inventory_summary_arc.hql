...
INSERT overwrite table ods_fd_romeo.ods_fd_inventory_summary_arc PARTITION (pt = '${hiveconf:pt}')
select 
...
demand_quantity,making_quantity,created_stamp,last_updated_stamp,last_updated_tx_stamp,created_tx_stamp,currency_uom_id,comments,uom_id,owner_party_id,party_id,unit_cost,
    ...
    from (
        ...
        select  pt,
                ...
                party_id,
                unit_cost
        from ods_fd_romeo.ods_fd_inventory_summary_arc where pt='${hiveconf:pt}'
        ...
        select  pt,
                ...
                party_id,
                unit_cost
        from ods_fd_romeo.ods_fd_inventory_summary_inc where pt='${hiveconf:pt}'
    ) arc 
