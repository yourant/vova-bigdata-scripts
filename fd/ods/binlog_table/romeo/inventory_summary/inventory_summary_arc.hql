alter table ods_fd_romeo.ods_fd_inventory_summary_arc drop if exists partition (pt='$pt');

INSERT into table ods_fd_romeo.ods_fd_inventory_summary_arc PARTITION (pt = '${pt}')
select 
