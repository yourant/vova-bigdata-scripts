...
-- now data
    ...
    order_sn STRING,
    user_id INT,
    order_time_original STRING COMMENT 'flume中原始订单时间数据',
    order_time BIGINT,
    order_status INT,
    shipping_status INT,
    pay_status INT,
    ...
    referer STRING,
    confirm_time BIGINT,
    pay_time_original STRING COMMENT 'flume收集的原始支付时间',
    pay_time BIGINT,
...
INSERT overwrite table ods_fd_vb.ods_fd_order_info_inc PARTITION (dt='${hiveconf:dt}',hour)
select 
