CREATE TABLE IF NOT EXISTS ods_fd_vb.ods_fd_goods_preorder_plan_arc
(
...
INSERT overwrite table ods_fd_vb.ods_fd_goods_preorder_plan_arc PARTITION (dt = '${hiveconf:dt}')
select id,
       plan_id,
       plan_name,
       project_name,
       ...
       reason,
       is_into_group
from tmp.tmp_fd_goods_preorder_plan_full;
