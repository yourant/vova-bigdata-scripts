...
sh /mnt/vova-bigdata-scripts/common/table_check.sh  ads.ads_fd_goods_target_14day 60000
...
sql="
drop table if exists data_report.ads_fd_goods_target_14day_new;
drop table if exists data_report.ads_fd_goods_target_14day_history;

CREATE TABLE IF NOT EXISTS \`data_report\`.\`ads_fd_goods_target_14day_new\` (
...
CREATE TABLE IF NOT EXISTS \`data_report\`.\`ads_fd_goods_target_14day\` (
  \`id\` int(11) NOT NULL AUTO_INCREMENT,
  \`goods_id\` int(11) COMMENT '商品id',
  \`cat_id\` varchar(50) COMMENT '品类id',
  \`country\` varchar(50) COMMENT '国家',
...
--m 1 \
--table ads_fd_goods_target_14day_new \
--hcatalog-database ads \
--hcatalog-table ads_fd_goods_target_14day \
...
rename table data_report.ads_fd_goods_target_14day to data_report.ads_fd_goods_target_14day_history,data_report.ads_fd_goods_target_14day_new to data_report.ads_fd_goods_target_14day;
EOF
