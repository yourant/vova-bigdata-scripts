...
sql="
drop table if exists data_report.ads_fd_goods_display_top_artemis_country_interval_new;
drop table if exists data_report.ads_fd_goods_display_top_artemis_country_interval_${pt};

CREATE TABLE IF NOT EXISTS \`data_report\`.\`ads_fd_goods_display_top_artemis_country_interval_new\` (
...
CREATE TABLE IF NOT EXISTS \`data_report\`.\`ads_fd_goods_display_top_artemis_country_interval\` (
  \`id\` int(11) NOT NULL AUTO_INCREMENT,
  \`goods_id\` int(11) COMMENT '商品ID',
  \`cat_id\` varchar(50) COMMENT '类目ID',
  \`country_code\` varchar(50) COMMENT '国家',
...
--m 1 \
--table ads_fd_goods_display_top_artemis_country_interval_new \
...
rename table data_report.ads_fd_goods_display_top_artemis_country_interval to data_report.ads_fd_goods_display_top_artemis_country_interval_${pt},data_report.ads_fd_goods_display_top_artemis_country_interval_new to data_report.ads_fd_goods_display_top_artemis_country_interval;
EOF
echo "-------rename结束--------"
