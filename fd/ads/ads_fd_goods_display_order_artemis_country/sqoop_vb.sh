...
sql="
CREATE TABLE IF NOT EXISTS \`vbridal\`.\`goods_display_order_artemis_country_new\` (
...
CREATE TABLE IF NOT EXISTS \`vbridal\`.\`goods_display_order_artemis_country\` (
  \`id\` int(11) NOT NULL AUTO_INCREMENT,
  \`goods_id\` int(11) COMMENT '商品ID',
  \`country_code\` varchar(50) COMMENT '国家',
  \`project_name\` varchar(50) COMMENT '组织',
...
--m 1 \
--table goods_display_order_artemis_country_new \
...
rename table vbridal.goods_display_order_artemis_country to vbridal.goods_display_order_artemis_country_${pt},vbridal.goods_display_order_artemis_country_new to vbridal.goods_display_order_artemis_country;
EOF
echo "-------rename结束--------"
