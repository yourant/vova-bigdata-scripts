...
#获取数据库配置信息
db_host=${ecshop_db[db_host]}
db_port=${ecshop_db[db_port]}
db_user_name=${ecshop_db[db_user_name]}
db_password=${ecshop_db[db_password]}
db_databases=${ecshop_db[db_databases]}
#hive数据库
hive_db_name="tmp"
