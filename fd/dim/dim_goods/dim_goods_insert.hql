...
select
  ...
  t2.root_cat_id as first_cat_id,
  t2.root_cat_name as first_cat_name,
  t2.first_cat_id as second_cat_id,
  t2.first_cat_name as second_cat_name,
  t2.second_cat_id as third_cat_id,
  t2.second_cat_name as third_cat_name,
