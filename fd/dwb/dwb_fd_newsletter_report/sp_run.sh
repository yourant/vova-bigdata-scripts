...
#脚本路径
shell_path="/mnt/vova-bigdata-scripts/fd/dwb/dwb_fd_newsletter_report"

#Newsletter 模块数据报表
hive -hiveconf dt=$dt -hiveconf dt_last=$dt_last -f ${shell_path}/dwb_fd_newsletter_snowplow.hql
