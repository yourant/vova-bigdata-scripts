...
-- 使用品类id代替品类名称进行对上述9个品类的限定 （存在几个id->一个名称的情况）
and cat_id in (163,168,141,154,167,162,195,84,174,171,3001,164)
-- 指定页面的曝光量
and (
...
where project in ('floryday','airydress') and mkt_source <> '' and page_code='product' and pt='${pt}'
