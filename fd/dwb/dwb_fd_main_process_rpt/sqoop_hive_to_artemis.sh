...
--connect jdbc:mysql://artemis-data.cpbbe5ehgjpf.us-east-1.rds.amazonaws.com:3306/main_process_rpt \
--username data-report --password C27PoowhAZIU$LHeI%Gs \
--table main_process_rpt \
--update-key "dt,project,platform_type,country,is_new_user,ga_channel" \
