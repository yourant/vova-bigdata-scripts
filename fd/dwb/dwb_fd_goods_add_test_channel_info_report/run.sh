...
#脚本路径
shell_path="/mnt/vova-bigdata-scripts/fd/dwb/dwb_fd_goods_add_test_channel_info_report"

#订单事实表dwd_fd_order_info
hive -hiveconf dt=$dt -f ${shell_path}/dwb_fd_goods_add_test_channel_info.hql
