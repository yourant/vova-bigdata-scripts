...
CREATE TABLE `dwb.dwb_fd_mid_goods_click_collect`(
  ...
  `country_code` string COMMENT '国家code',
  `platform_type` string COMMENT '平台',
  `add_rate_before` decimal(15,6) COMMENT '商品加车率-调价前',
  `add_rate_after` decimal(15,6) COMMENT '商品加车率-调价后',
  `rate_before` decimal(15,6) COMMENT '商品转化率-调价前',
  `rate_after` decimal(15,6) COMMENT '商品转化率-调价后',
  `ctr_before` decimal(15,6) COMMENT '商品点击率-调价前',
  `ctr_after` decimal(15,6) COMMENT '商品点击率-调价后',
  `cr_before` decimal(15,6) COMMENT '商品CR-调价前',
  `cr_after` decimal(15,6) COMMENT '商品CR-调价后',
...
CREATE TABLE `dwb.dwb_fd_goods_adjust_price_rpt`(
  ...
  `purchase_price` decimal(15,2) COMMENT '商品采购价',
  `avg_shop_price_before` decimal(15,2) COMMENT '平均销售价-调价前',
  `avg_shop_price_after` decimal(15,2) COMMENT '平均销售价-调价后',
  `adjust_price_range` decimal(15,6) COMMENT '调价幅度',
  `goods_number_before` bigint COMMENT '销售数量-调价前',
  `goods_number_after` bigint COMMENT '销售数量-调价后',
  `shop_price_before` decimal(15,2) COMMENT '销售额-调价前',
  `shop_price_after` decimal(15,2) COMMENT '销售额-调价后',
  `total_shop_price_before` decimal(15,6) COMMENT '总的销售额-调价前（全平台）',
  `total_shop_price_after` decimal(15,6) COMMENT '总的销售额-调价后（全平台）',
  `shop_amount_rate_before` decimal(15,6) COMMENT '销售金额占比-调价前',
  `shop_amount_rate_after` decimal(15,6) COMMENT '销售金额占比-调价后',
  `add_rate_before` decimal(15,6) COMMENT '加车率-调价前',
  `add_rate_after` decimal(15,6) COMMENT '加车率-调价后',
  `ctr_before` decimal(15,6) COMMENT '商品点击率CTR-调价前',
  `ctr_after` decimal(15,6) COMMENT '商品点击率CTR-调价后',
  `rate_before` decimal(15,6) COMMENT '商品转化率Rate-调价前',
  `rate_after` decimal(15,6) COMMENT '商品转化率Rate-调价后',
  `cr_before` decimal(15,6) COMMENT '商品CR-调价前',
  `cr_after` decimal(15,6) COMMENT '商品CR-调价后',
  `click_before` bigint COMMENT '调价前点击会话数',
  `click_after` bigint COMMENT '调价后点击会话数',
