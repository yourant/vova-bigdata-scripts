...
CREATE TABLE `dwb.dwb_fd_goods_adjust_price_rpt`(
  ...
  `purchase_price` decimal(15,6) COMMENT '商品采购价',
  `avg_shop_price_before` decimal(15,6) COMMENT '平均销售价-调价前',
  `avg_shop_price_after` decimal(15,6) COMMENT '平均销售价-调价后',
  ...
  `shop_price_before` decimal(15,6) COMMENT '销售额-调价前',
  `shop_price_after` decimal(15,6) COMMENT '销售额-调价后',
