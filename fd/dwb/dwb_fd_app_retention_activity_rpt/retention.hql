insert overwrite table dwb.dwb_fd_app_retention_activity partition (pt='${hiveconf:pt}',classify='retention')
select
...
from(
	...
	from (
		...
		where  pt = date_sub('${hiveconf:pt}',1) and platform_type in ('android_app','ios_app')
	...
	where pt = '${hiveconf:pt}' and platform_type in ('android_app','ios_app')
