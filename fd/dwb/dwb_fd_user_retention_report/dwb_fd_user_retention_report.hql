...
(
    ...
    goods_amount            double comment '销售额',
    paid_orders             int  comment '已支付订单量',
    paid_users              int  comment'今天访问用户中有历史下单的',
    uv                       bigint comment 'uv(今天访问用户)',
    access_today_users_new   int COMMENT '今天新访问用户',

    access_1ago_users       int COMMENT '1天前访问用户',
    access_both1_users      int COMMENT '1天前和今天都访问用户',
    access_7ago_users       int COMMENT '7天前访问用户',
    access_both7_users      int COMMENT '7天前和今天都访问用户',
    access_28ago_users      int COMMENT '28天前访问用户',
    access_both28_users     int COMMENT '28天前和今天都访问用户',
    access_1ago_users_new   int COMMENT '1天前新访问用户',
    access_both1_users_new  int COMMENT '1天前新访问用户在今天也访问的用户',
    access_7ago_users_new   int COMMENT '7天前新访问用户',
    access_both7_users_new  int COMMENT '7天前新访问用户在今天也访问的用户',
    access_28ago_users_new  int COMMENT '28天前新访问用户',
    access_both28_users_new int COMMENT '28天前新访问用户在今天也访问的用户'
