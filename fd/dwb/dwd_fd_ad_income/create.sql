CREATE external TABLE IF NOT EXISTS dwb.dwb_ad_income_order
(
    cat_name       STRING,
    day_value         STRING,
    day_rate           STRING,
...
CREATE external TABLE IF NOT EXISTS dwb.dwb_ad_income_out_stock
(
    cat_name       STRING,
    day_value         STRING,
    day_rate           STRING,
...
CREATE external TABLE IF NOT EXISTS tmp.tmp_ad_income_01
(
    day_order_cnt         int,
...
CREATE external TABLE IF NOT EXISTS tmp.tmp_ad_income_02
(
...
CREATE external TABLE IF NOT EXISTS tmp.tmp_ad_income_03
(
    day_order_cnt         int,
    day_gmv           decimal(15,4),
    day_bonus         decimal(15,4),
