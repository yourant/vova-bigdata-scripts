CREATE external TABLE IF NOT EXISTS dwb.dwb_fd_income_order
(
    cat_name       STRING,
    day_value         STRING,
    day_rate           STRING,
...
CREATE external TABLE IF NOT EXISTS dwb.dwb_fd_income_out_stock
(
    cat_name       STRING,
    day_value         STRING,
    day_rate           STRING,
...
CREATE external TABLE IF NOT EXISTS tmp.tmp_fd_income_01
(
    day_order_cnt         int,
...
CREATE external TABLE IF NOT EXISTS tmp.tmp_fd_income_02
(
...
CREATE external TABLE IF NOT EXISTS tmp.tmp_fd_income_03
(
    day_order_cnt         int,
    day_gmv           decimal(15,4),
    day_bonus         decimal(15,4),
