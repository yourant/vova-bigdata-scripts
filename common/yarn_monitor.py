...
if __name__ == "__main__":
    ...
    url = "http://ip-10-108-6-131.ec2.internal:8088/ws/v1/cluster/apps?state=RUNNING,ACCEPTED"
    arr = []
    try:
        conn = httplib.HTTPConnection("ip-10-108-6-131.ec2.internal", 8088)
